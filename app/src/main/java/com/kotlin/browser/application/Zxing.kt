...
/**
 *
 * @see https://github.com/zxing/zxing/blob/master/android/src/com/google/zxing/client/android/DecodeFormatManager.java
 */
...
object Intents {
    ...
    const val FLAG_NEW_DOC = Intent.FLAG_ACTIVITY_NEW_DOCUMENT
